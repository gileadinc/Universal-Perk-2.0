      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 space-y-24">
        ...
        <div>
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-3xl mx-auto">
              Missed appointments and booking delays cost businesses millions. Customers get frustrated waiting for confirmations.
            </p>
          </div>
          ...
          <div className="mt-12 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 p-10 text-white shadow-xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2">Real Impact</h3>
                <p className="text-blue-50 text-lg">
                  Businesses using AI scheduling bots see a 25-35% increase in booked appointments and fewer last-minute cancellations.
                </p>
              </div>
            </div>
          </div>
